...
$searchresponse = $dbfunc->searchResponse($first,$searchValue);
...
<?php include "inc/header2.php"; ?>
    ...
    <main>
        ...
        <div class="container p-t-4 p-b-40">
            <h2 class="f1-l-1 cl2">
              <?php
              if ($first == 'tags') echo 'Tag: '; else echo 'Results for: ';
                echo $searchValue;
                ?>
            </h2>
        </div>
                            ...
                            for ($i = 0; $i < count($searchresponse); $i++) {
                                ...
                                <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                    <div class="m-b-45">
                                        ...
                                        <div class="p-t-16">
                                            <h5 class="p-b-5">
                                                <a href="../detail/<?php echo $searchresponse[$i]['id'] ?>" class="f1-m-3 cl2 hov-cl10 trans-03">
