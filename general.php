...
if (isset($_GET["gencat"])) {
    $genCat = str_replace("+", " ", $_GET["gencat"]);
} else {
...
$allgenCat = $dbfunc->getAllGeneralNews($genCat);
...
<div class="container p-t-4 p-b-40" style="margin-top: 40px;">
    <h2 class="f1-l-1 cl2">
        <?php echo $allgenCat[0]['sub_categories']; ?>
    </h2>
</div>
            ...
            <div class="col-md-10 col-lg-8 p-b-80">
                <div class="p-r-10 p-r-0-sr991">
                    <div class="m-t--65 p-b-40">
                        <?php
                        for ($i = 0; $i < count($allgenCat); $i++) {
                        ?>
                            <div class="flex-col-s-c how-bor2 p-t-65 p-b-40">
                                <a href="../interviewdetails/<?php echo $allgenCat[$i]['id'];?>" class="f1-s-10 cl2 text-uppercase txt-center hov-cl10 trans-03 p-b-40">
                                    <!-- <?php echo $allgenCat[$i]['sub_categories'];?> -->
                                </a>
                                <h5 class="p-b-17 txt-center">
                                    <a href="../interviewdetails/<?php echo $allgenCat[$i]['id'];?>" class="f1-l-1 cl2 hov-cl10 trans-03 respon2">
                                    <?php echo $allgenCat[$i]['heading'];?>
                                    </a>
                                </h5>
                                <div class="cl8 txt-center p-b-24">
                                    <a href="../interviewdetails/<?php echo $allgenCat[$i]['id'];?>" class="f1-s-4 cl8 hov-cl10 trans-03">
                                        by <?php echo $allgenCat[$i]['author'];?>
                                    </a>
                                    <span class="f1-s-3 m-rl-3">
                                        -
                                    </span>
                                    <span class="f1-s-3">
                                    <?php echo $dbfunc->getDateFromString($allgenCat[$i]['date_published']);?>
                                    </span>
                                </div>
                                <a href="../interviewdetails/<?php echo $allgenCat[$i]['id'];?>" class="wrap-pic-w hov1 trans-03 m-b-30">
                                    <img src="<?php echo $baseImageUrl.$allgenCat[$i]['image_url'];?>_0.PNG" alt="IMG">
                                </a>
                                <p class="f1-s-11 cl6 txt-center p-b-22">
                                    <?php echo $allgenCat[$i]['short_description'];?>
                                </p>
                                <a href="../interviewdetails/<?php echo $allgenCat[$i]['id'];?>" class="f1-s-1 cl9 hov-cl10 trans-03">
                                    Read More
                ...
                <div class="p-l-10 p-rl-0-sr991">
                    ...
                    <div>
                        ...
                        <div class="flex-wr-s-s m-rl--5">
                            <?php 
                                $allCats = ["Business","Courts", "Crime", "Election Petition", "Others"];


                                foreach ($allCats as $key => $value) {
                                    if($value != $genCat ){
                                        ?>
                                            <a href="<?php echo $baseUrl; ?>general/<?php echo str_replace(" ", "+", $value); ?>" class="flex-c-c size-h-2 bo-1-rad-20 bocl12 f1-s-1 cl8 hov-btn2 trans-03 p-rl-20 p-tb-5 m-all-5">
                                                <?php echo $value ?>
                                            </a>
                                        <?php
                                    }
