          ...
          <div class="container">
            <div class="row d-flex align-items-center">
              <div class="col-xl-3 col-lg-3 col-md-3">
                <div class="logo">
                  <a href="javascript:void(0)"><img src="assets/img/logo/logo.jpg" alt="" height="70px" style="height: 70px !important" /></a>
                </div>
              </div>
            ...
            <div class="row align-items-center">
              <div class=" nav-categories col-md-12 header-flex">
                <div class="sticky-logo">
                  <a href="./"><img src="assets/img/logo/logo.jpg" alt="" height="62px" style="height: 62px !important" /></a>
                </div>
                    ...
                    <ul id="navigation" style="background-color: white">
                      ...
                      <li><a href="javascript:void(0);">General News</a>
                        <ul class="submenu">
                          ...
                          <!-- <li><a href="general/Others">Others</a></li> -->
                        </ul>
                      </li>
